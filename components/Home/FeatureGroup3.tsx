...
export const FeatureGroup3 = () => {
  return (
    <div className="bg-linen dark:bg-hunter text-hunter dark:text-linen px-8 featuregroup3">
      <div className="max-w-screen-xl mx-auto py-48 space-y-32 lg:space-y-72">
        <article className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 featuregroup3-article">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg leading-loose mt-8" data-speed="0.98">
          ...
          <div
            className="order-1 lg:order-2 bg-gradient-to-tl dark:from-linen-400/20 from-hunter-400/20 dark:to-[#F2663F] to-[#F2663F] shadow-cool rounded-2xl col-span-1  relative pt-8 px-20"
            data-speed="1.05"
          >
